...
func Test_Search(t *testing.T)  {
	...
	t.Run("Testing Many file,One flag{-n}", Test_FlagOneFileMany1)
	t.Run("Testing Many file,One flag{-l}", Test_FlagOneFileMany2)
	t.Run("Testing Many file,One flag{-i}", Test_FlagOneFileMany3)
	t.Run("Testing Many file,One flag{-v}", Test_FlagOneFileMany4)
	t.Run("Testing Many file,One flag{-x}", Test_FlagOneFileMany5)
